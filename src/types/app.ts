export type AppName = 'fileExplorer' | 'notepad' | 'calculator' | 'settings' | 'weather' | 'calendar' | 'browser' | 'terminal' | 'refy' | 'movie' | 'game' | 'email' | 'store' | 'taskmanager' | 'updatecenter' | 'music' | 'photos' | 'paint';
